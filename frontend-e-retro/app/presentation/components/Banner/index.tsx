                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-8'>
                    ...
                    <div className='col-span-6 flex flex-col justify-evenly'>
                        <div className='flex gap-2 mx-auto lg:mx-0'>
                            ...
                            <h3 className='text-kellygreen text-sm font-semibold text-center lg:text-start'>Get 30% off on first 100</h3>
                        </div>
                        <h1 className='text-midnightblue text-4xl sm:text-5xl font-semibold text-center lg:text-start lh-120 pt-5 lg:pt-0'>Achieve great results with easy guidance at Advanced Level Education Center..</h1>
                        <h3 className='text-charcoal text-lg font-normal text-center lg:text-start opacity-75 pt-5 lg:pt-0'>Build expertise through our courses and mentorship from world-class professionals.</h3>
                        ...
                        <div className='flex items-center justify-between pt-10 lg:pt-4'>
                            ...
                            <div className='flex gap-2'>
                                <Image src="/assets/banner/check-circle.svg" alt="check-image" width={30} height={30} className='smallImage'/>
                                <p className='text-sm sm:text-lg font-normal text-black'>Learning</p>
                            </div>
                            <div className='flex gap-2'>
                                <Image src="/assets/banner/check-circle.svg" alt="check-image" width={30} height={30} className='smallImage'/>
                                <p className='text-sm sm:text-lg font-normal text-black'>Result</p>
                            </div>
                        </div>
                    </div>

                    <div className='col-span-6 flex justify-center'>
                        <Image src="/assets/banner/banner_img.png" alt="nothing" width={1000} height={805} />
                    </div>
                </div>
            </div>
        </div>
